...
class Visita():
    ...
    def guivisita(self):
        ...
        # enter_info1.grid(row=16, column=0, padx=5, pady=5)
        # self.m1 = Entry(self.root, justify='center', textvariable = self.r, state='disable')
        # self.m1.grid(row=16, column=1, padx=5, pady=5)
        # self.m1.config(width=self.i)

        # enter_info2 = Label(self.root, text='\nTeste Paciente:', bg="lightgrey")
        # enter_info2.grid(row=17, column=0, padx=5, pady=5)
        # self.m2 = Entry(self.root, justify='center', textvariable = self.pac, state='disable')
        # self.m2.grid(row=17, column=1, padx=5, pady=5)
        # self.m2.config(width=self.i)
